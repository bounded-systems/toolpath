...
cargo run -p path-cli -- p cache sync --project-under ~/work/proj  # only sessions whose project is under this directory
...
# --project-under <dir> scopes both the sync and the read to sessions whose
# project directory is under that subtree.
